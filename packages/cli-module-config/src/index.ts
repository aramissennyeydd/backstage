...
export function registerCommands(program: Command) {
  program
    ...
    .action(lazy(() => import('./commands/config/print').then(m => m.default)));
  ...
  program
    ...
    .action(
      lazy(() => import('./commands/config/validate').then(m => m.default)),
    );
  ...
  program
    ...
    .action(
      lazy(() => import('./commands/config/schema').then(m => m.default)),
    );
  ...
  program
    ...
    .action(lazy(() => import('./commands/config/docs').then(m => m.default)));
}
